            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" action="{{url('/admin/add-banners')}}" name="add_banners" id="add_banners" enctype="multipart/form-data" novalidate="novalidate">{{ csrf_field() }}
