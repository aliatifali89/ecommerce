           ...
           @endif
            ...
            <form id="loginform" class="form-vertical" method= "post" action="{{url('admin')}}">{{csrf_field()}}
                ...
                <div class="form-actions">
                    <span class="pull-left"><a href="#" name="lostpassword" class="flip-link btn btn-info" id="to-recover">Lost password?</a></span>
                    <span class="pull-right"><input type="submit" href="" name="submit" value="Submit" class="btn btn-success" /></span>
                </div>
            </form>
