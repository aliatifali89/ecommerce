            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" action="{{url('/admin/add-coupons')}}" name="add_coupon" id="add_coupon">{{ csrf_field() }}
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="expdate" id="expdate" autocomplete="off" required>
                                </div>
                            </div>
