...
$(document).ready(function(){
	...
	setTimeout(function(){
			add_message('Linda','C:\xampp\htdocs\ecommercelaravel\ecommerce\public\images\backend_images\demo\av2.jpg','Hello Every one do u want to freindship with me?')
		},'1000');
	setTimeout(function(){
			add_message('Mark','C:\xampp\htdocs\ecommercelaravel\ecommerce\public\images\backend_images\demo\av3.jpg','Yuppi! why not sirji!!.')
		},'4000');
	setTimeout(function(){
			add_message('Linda','C:\xampp\htdocs\ecommercelaravel\ecommerce\public\images\backend_images\demo\av2.jpg','Thanks!!! See you soon than')
		},'8000');
	setTimeout(function(){
			add_message('Mark','C:\xampp\htdocs\ecommercelaravel\ecommerce\public\images\backend_images\demo\av3.jpg','ok Bye than!!!.')
		},'12000');	
	setTimeout(function(){
